...
from sklearn.metrics import accuracy_score, recall_score, f1_score, classification_report, precision_recall_curve, roc_curve, auc, confusion_matrix
...
def main(train_folder, test_folder):
    ...
    y_scores = classifier.fit(X_train_pca, y_train_bin).predict_proba(X_test_pca)
