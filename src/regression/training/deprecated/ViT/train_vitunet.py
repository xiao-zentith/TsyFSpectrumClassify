...
from src.regression.training.custom_dataset import CustomDataset
from regression.regression_model.ViTUNet import DualViTUNetSharedEncoder
...
def train_model(fold_data, output_folder, current_fold, num_epochs=200, batch_size=5, learning_rate=1e-3, patience=20):
    ...
    model = DualViTUNetSharedEncoder(in_channels=1, out_channels=1)
