...
# from utils.metrics.pearson_calculator import pearson_corr_matrix
...
# 示例用法
file_path = r'/home/asus515/PycharmProjects/TsyFSpectrumClassify_remote/results/regression/DualUNetSharedEncoder/training_20251105_022308/fold_15/test_sample_0_target_0.npz'  # 替换为你的.npz文件路径
