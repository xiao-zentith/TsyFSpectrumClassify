...
class AdaptiveCNN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # 固定全连接层
        self.fc1 = nn.Linear(64 * 14 * 3, 128)  # 假设输入尺寸为 63x21，经过两次池化后变为 13x13
        self.fc2 = nn.Linear(128, 256)
        self.fc3 = nn.Linear(256, 1323)  # 特征数固定为 1323

    def forward(self, x):
        original_shape = (63, 21)  # 固定输出形状为 63x21
        batch_size = x.size(0)
...
if __name__ == "__main__":
    ...
    print("分支1输出形状:", out1.shape)  # 应为 (1, 1, 63, 21)
    print("分支2输出形状:", out2.shape)  # 应为 (1, 1, 63, 21)
