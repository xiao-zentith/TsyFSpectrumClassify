...
if __name__ == "__main__":
    model_root_folder = "/home/asus515/PycharmProjects/TsyFSpectrumClassify_remote/regression/dataset_result/C6 + FITC/DualSimpleCNN/training_20250526_211643"  # 替换为你的根目录路径
    dataset_info_json = "/home/asus515/PycharmProjects/TsyFSpectrumClassify_remote/regression/config/dataset_info_C6_FITC.json"  # 替换为你的dataset_info路径
